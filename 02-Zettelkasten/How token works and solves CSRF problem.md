...
Then you <mark style="background: #CACFD9A6;">manually store it in Local Storage</mark> in the frontend:
...
you <mark style="background: #CACFD9A6;">manually add that token to the header</mark>:
...
The <mark style="background: #D2B3FFA6;">browser automatically stores these cookies</mark>.

When sending your next requests, the <mark style="background: #D2B3FFA6;">browser automatically includes those cookies in the request</mark>.
