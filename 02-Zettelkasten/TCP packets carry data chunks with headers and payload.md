...
A **packet** is a chunk of data that gets transmitted over the network. When you send data across the internet, it doesn't travel as one continuous stream—it's broken into smaller pieces called packets.

Think of it like shipping a 1000-page book. Instead of one massive shipment, you break it into smaller boxes (packets), maybe 10 boxes with 100 pages each. Each travels independently through the postal system and gets reassembled at the destination.
