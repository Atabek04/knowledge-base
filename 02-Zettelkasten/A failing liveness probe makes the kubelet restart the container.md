...
A **liveness probe** answers one question: <mark style="background: #FFF3A3A6; font-weight: bold;">is the process alive, or has it wedged into a state it can never recover from?</mark> It is the kubelet's tool for self-healing a stuck container.
