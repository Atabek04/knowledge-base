...
<mark style="background: #ffd400">SSE (Server-Sent Events)</mark> is a standard for pushing data from server to client over a plain HTTP connection that stays open indefinitely.
...
Key characteristics:
- <mark style="background: #ffd400">**Unidirectional**</mark>: server → client only
