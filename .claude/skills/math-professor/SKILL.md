...
**Log format.** One line appended to `../Ribaat/Knowledge-Base/Machine-Learning/LinAlg-Session-Log.md` (Ribaat vault):
...
| Session log | `Knowledge-Base/Machine-Learning/LinAlg-Session-Log.md` | Ribaat |
