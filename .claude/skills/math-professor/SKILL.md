...
| Dose | 30 min/day through September 2026, 1 h/day from 1 October 2026 |
...
| Artefact | Path | Vault |
|---|---|---|
| MOC | `01-MOCs/AI-ML/Linear Algebra MOC.md` | Knowledge-Base |
| Atomic notes | `02-Zettelkasten/` | Knowledge-Base |
| Cards | `05-Flashcards/math/linear-algebra.md`, deck `Tech-KB::Math for ML::Linear Algebra`, note type `Coding Questions` | Knowledge-Base |
