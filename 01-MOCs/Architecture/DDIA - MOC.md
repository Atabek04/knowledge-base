...
Notes: 21 · Route: [[Architecture - MOC]] · Skip only the Summary section and the "why data-intensive" opening — the reliability, percentile, and maintainability material is load-bearing for the rest of the book, not framing. Ch1 is *light to read*, not light to atomize.
