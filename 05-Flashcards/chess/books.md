TARGET DECK: Tech-KB::Chess::Books
Tags: chess books
**Related:** [[Chess MOC]]
...
START
Coding Questions
What is Silman's imbalances method, and what does it replace?
...
START
Coding Questions
Silman's *The Amateur's Mind* vs *How to Reassess Your Chess* — which first and why?
Back:
...
START
Coding Questions
What is Silman's rule for *how much* endgame theory to study?
...
START
Coding Questions
What is de la Villa's "100 Endgames You Must Know" approach to practical endgame strength?
...
START
Coding Questions
What does Chernev's "Logical Chess: Move by Move" teach, and what's its core demand?
...
START
Coding Questions
Why pair Seirawan's "Winning Chess Tactics" with Polgar's "Chess Tactics for Champions"?
Back: They do **different jobs in sequence**:
- Seirawan = *understand* the motif (explainer, too few exercises alone)
...
START
Coding Questions
Why is Nimzowitsch's "My System" recommended *later* despite being a classic?
