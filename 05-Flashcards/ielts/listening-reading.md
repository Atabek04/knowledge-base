...
- Hyphenated words count as **one** (*check-in*)
...
- Headings deliberately resemble each other; the main idea is sometimes in the **last** sentence; answers aren't guaranteed in order
...
- But Bax's eye-tracking study found successful and unsuccessful candidates differ significantly in *expeditious reading* ability
